...
function Login() {
  const { setCredentials, setCustomerCredentials, token } = useAuth();
  ...
  const login = async () => {
    ...
    try {
      ...
      console.log(data);
      setCustomerCredentials(data.token, data.customer);
  ...
  return (
    <div className="flex flex-col items-center h-[100vh] bg-[#fcfcf9]">
      ...
      <div className="flex h-[530px] bg-red-500 rounded-md overflow-hidden sm:h-fit">
        ...
        <div className=" z-[10] flex flex-col items-center w-[430px] bg-white gap-3 p-5 border-[1px] pt-10 shadow-sm rounded-sm">
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            <NavLink to="/register" className="text-sm text-[#f54749]">
              สมัครสมาชิก
            </NavLink>
          </div>
